    ...
    public class SaveFile {
       ...
       public SaveFile(){}
        ...
        public static void Start() {
            ...
            var path = Path.Combine(Application.streamingAssetsPath, "StartItems.txt");
            var items = File.ReadLines(path).Select(int.Parse);
            RouletteManager.Init(items);
        ...
        public static void Load(string pPath) {
            ...
            var data = JsonConvert.DeserializeObject<SaveFile>(context, setting);
