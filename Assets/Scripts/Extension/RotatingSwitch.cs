...
namespace Extension {
    ...
    public abstract class RotatingSwitch: MonoBehaviour {
        ...
        [SerializeField] protected bool _rgbMode = false;
            ...
            _animation = DOTween.Sequence()
                ...
                .Join(
                    DOTween.To(
                        ...
                        t => {
                            process = t;
                            _board.material.SetColor("_AfterColor",
                                _rgbMode
                                    ? Color.Lerp(start, end, process)
                                    : ExColor.Lerp(startLch, endLch, process).ToColor()
                            );
                        },
                        1,
                        _animationDuration
